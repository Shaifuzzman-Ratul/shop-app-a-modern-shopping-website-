      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="absolute bottom-4 left-4 right-4 flex gap-2">
                      <Link
                        ...
                        className="flex-1 bg-white text-brand py-2 px-4 rounded-lg font-semibold text-center hover:bg-gray-100 transition-colors"
                      >
                        View Details
                      </Link>
                      <button className="bg-brand text-white py-2 px-4 rounded-lg font-semibold hover:bg-brand-dark transition-colors">
                        Quick Add
                      </button>
                    </div>
                  </div>
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-3">
                    <h3 className="text-xl font-semibold text-brand-dark group-hover:text-brand transition-colors">
                      {product.name}
                    </h3>
                    <div className="flex items-center space-x-1">
                      {[...Array(5)].map((_, i) => (
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {product.features.slice(0, 3).map((feature, featureIndex) => (
                      <span
                        key={featureIndex}
                        className="text-xs bg-brand-light/20 text-brand px-2 py-1 rounded-full"
                      >
                        {feature}
                      </span>
                    ))}
          ...
          <div className="text-center mt-12">
            <Link
              href="/items"
              className="inline-flex items-center bg-brand text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-brand-dark transition-colors"
            >
              View All Products
